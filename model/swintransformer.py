    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        if downsample:
            if not is_SPT:
                ...
                self.downsample = ShiftedPatchTokenization(dim, dim * 2, 2, merging=True)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=2, in_chans=3,
                 ...
                 norm_layer=nn.LayerNorm, patch_norm=True, ape=False,
                 use_checkpoint=False, is_LSA=False, is_SPT=True, out_indices=(0, 1, 2, 3),
                 **kwargs):
        super().__init__()
